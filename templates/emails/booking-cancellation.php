...
<h1 class="appointiva-email-heading">
	...
	printf(
		...
		esc_html__( 'Your booking was cancelled, %s', 'appointiva' ),
		esc_html( $customer->first_name )
	);
	?>
</h1>
<p><?php esc_html_e( 'The following appointment has been cancelled:', 'appointiva' ); ?></p>
...
<?php do_action( 'appointiva_email_cancellation_body', $booking, $customer ); ?>
